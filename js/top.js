    ...
    $.fn.extend({
        ...
        top(option,child){
            ...
            $(this).prepend('<nav class="navbar navbar-expand-lg navbar-light bg-light">\n' +
                ...
                '                               <a class="nav-link" href="./article.html">技术文章</a>\n' +
                '                           </li>\n' +
                ...
                '                                       <a class="dropdown-item item-four-frist active" href="./Solution.html">注塑成型企业生产排程解决方案</a>\n' +
                '                                       <a class="dropdown-item item-four-second" href="./mjzz.html">模具制造企业生产排程需求及解决方案</a>\n' +
                '                                       <a class="dropdown-item item-four-third" href="./smtplanmate.html"> PCBA/SMT行业生产排程难点与解决方案</a>\n' +
                '                                       <a class="dropdown-item item-four-fourth" href="#">适合中小企业的半自动排程PLANMATECAS</a>\n' +
                '                                   </div>\n' +
                '                           </li>\n' +
